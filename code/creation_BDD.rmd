...
- PW010 abs : Sentiment de statisfaction dans la vie
...
filter_base_p <- function(country) {
  return(select(country, PB010, PB030, PB190, PH010, PH020, PH030, PH040, PH050, PH060, PH070))
}
filter_base_d <- function(country) {
  return(select(country, DB020, DB030))
}
filter_base_h <- function(country) {
  return(select(country,  HB030)) # TODO Filter efficiently
...
for (i in 2006:2013)  {
  ...
  AT_people <- bind_rows(AT_people, import_year_people("AT", i))
